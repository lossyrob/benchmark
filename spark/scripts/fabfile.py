...
# for fabric
env.user = 'ubuntu'
env.host_string = 'ec2-52-5-15-24.compute-1.amazonaws.com'  # The public-facing DNS we want fabric to point at
env.key_filename = '/Users/rob/.keys/geotrellis-spark-test.pem'
